...
DESKTOPCODE='../../../application/client/desktop/k8s1_6557'
DESKTOPIMAGENAME='geppettotest/k8s1_6557-desktop:1.0'
...
helm install --name k8s1_6557 ./helm
if [ $? -eq 0 ]; then
